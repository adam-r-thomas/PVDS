...
TODO: place in thread access limits for the gpu methods
'''
import math
...
float64, int8)''')
def intersection_gpu_old(Px, Py, Vi, angle, cast, epsilon, dec):
    """
...
float64, int8)''')
def grid_gpu_old(Px, Py, Vx, Vy, model_resolution, epsilon, dec):
    '''
